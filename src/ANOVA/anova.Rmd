...
metadata_file <- read_csv("../../data/metadata_timeseries_dereplicated.csv", 
                          col_types = cols_only(
                            ...
                            diet = col_factor(), 
                            smoker = col_factor(), 
                            Gestational_approximated_weeks = col_double(), 
                            abx_at_birth = col_factor(), 
                            Birth_weight = col_double(), 
                            sum_read_count = col_double(), 
                            sum_base_count = col_double(),
...
#save plots
```{r}
pdf(file=paste0("../../figures/ANOVA/heatmap.p.adj.pdf"), width=10, height=8)
